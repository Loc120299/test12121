            ...
            <section >
              <div >
                <div v-if='isShowDefault' >
                  <h3 class='font-medium'>REFERENCE TRANSACTIONS</h3>
                  <p>
                    When you make a purchase with Paypal on our website you will be
                    using reference transactions. Reference transactions allow faster
                    checkout when you want to purchase more products after your first
                    purchase using Paypal.
                  </p>
                  <h3 class='font-medium'>OVERVIEW</h3>
                  <p>
                    This website is operated by&nbsp;{{ $store.state.store.storeName }} Store ({{
                      $store.state.store.address
                    }}). Throughout the site, the terms &ldquo;we&rdquo;,
                    &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to
                    {{ $store.state.store.logoText }} Store.&nbsp;Europe&nbsp;offers&nbsp;this website,
                    ...
                    visiting our site and/ or purchasing something from us, you engage
                    in our &ldquo;Service&rdquo; and agree to be bound by the
                    ...
                    site,&nbsp;including&nbsp;without&nbsp;limitation&nbsp;users who
                  ...
                  <p>
                    The following materials are not permitted at {{ $store.state.store.logoText
                    }}<br />No text or images that infringe on any intellectual
                    property rights including, but not limited to copyrights,
                    trademarks and rights of privacy/publicity.<br />No text or images
                    of obscenity, pornography or nudity that is not artistic in
                    nature.<br />No text or images that encourage or glorify drug
                    use/abuse. No excessive violence.<br />No content that is libelous
                    or defamatory. No content that can reasonably be viewed as
                    harassing, threatening, or otherwise harmful.<br />No hate speech.
                    No content that can reasonably be viewed as discriminatory based
                    upon race, ethnicity, national origin, sexual orientation, gender,
                    gender identity or disability.<br />No content that violates or
                    encourages anyone else to violate any law.<br />Any products that
                    are deemed unacceptable by the rules above, or deemed offensive or
                    in bad taste at the sole judgment of {{ $store.state.store.logoText }}, will be
                    canceled and removed from the Marketplace with or without notice
                  </p>
                  <h3 class='font-medium'>SECTION 1 &ndash; ONLINE STORE TERMS</h3>
                  <p>
                    ...
                    any of your minor dependents to use this site.<br />You may not
                  ...
                  <h3 class='font-medium'>SECTION 2 &ndash; GENERAL CONDITIONS</h3>
                  <p>
                    We reserve the right to refuse service to anyone for any reason at
                    any time.<br />You understand that your content (not including
                    ...
                    during transfer over networks.<br />You agree not to reproduce,
                  ...
                  <h3 class='font-medium'>
                    SECTION 3 &ndash; ACCURACY, COMPLETENESS AND TIMELINESS OF
                    INFORMATION
                  </h3>
                  <p>
                    ...
                    this site is at your own risk.<br />This site may contain certain
                  ...
                  <h3 class='font-medium'>SECTION 4 &ndash; MODIFICATIONS TO THE SERVICE AND PRICES</h3>
                  <p>
                    ...
                    (or any part or content thereof) without notice at any time.<br />We
                    shall not be liable to you or to any third-party for any
                    modification, price change, suspension or discontinuance of the
                    Service. After purchasing a product, we may give you the option to
                    buy another product from our store at extra cost, you are welcome
                    to accept or decline this upsell&nbsp;on&nbsp;your own discretion.
                  </p>
                  <h3 class='font-medium'>SECTION 5 &ndash; PRODUCTS OR SERVICES (if applicable)</h3>
                  <p>
                    Certain products or services may be available exclusively online
                    through the website. These products or services may have limited
                    quantities and are subject to return or exchange only according to
                    our Return Policy.<br />We have made every effort to display as
                    accurately as possible the&nbsp;colors&nbsp;and images of our
                    products that appear at the store. We cannot guarantee that your
                    computer monitor&rsquo;s display of any&nbsp;color&nbsp;will be
                    ...
                    of us. We reserve the right to discontinue any product at any
                    time. Any offer for any product or service made on this site is
                    void where prohibited.<br />We do not warrant that the quality of
                  ...
                  <h3 class='font-medium'>
                    SECTION 6 &ndash; ACCURACY OF BILLING AND ACCOUNT INFORMATION
                  </h3>
                  <p>
                    ...
                    distributors.<br /><br />You agree to provide current, complete
                    and accurate purchase and account information for all purchases
                    made at our store. You agree to promptly update your account and
                    other information, including your email address and credit card
                    numbers and expiration&nbsp;dates,&nbsp;so that we can complete
                    your transactions and contact you as needed.<br /><br />For more
                    detail, please review our Returns Policy.
                  </p>
                  <h3 class='font-medium'>SECTION 7 &ndash; OPTIONAL TOOLS</h3>
                  <p>
                    ...
                    from or relating to your use of optional third-party tools.<br />Any
                    use by you of optional tools offered through the site is entirely
                    ...
                    by the relevant third-party provider(s).<br />We may also, in the
                  ...
                  <h3 class='font-medium'>SECTION 8 &ndash; THIRD-PARTY LINKS</h3>
                  <p>
                    Certain content, products and services available via our Service
                    may include materials from third-parties.<br />Third-party links
                    ...
                    third-party&rsquo;s policies and practices and make sure you
                  ...
                  <h3 class='font-medium'>
                    SECTION 9 &ndash; USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS
                  </h3>
                  <p>
                    ...
                    (collectively, &lsquo;comments&rsquo;), you agree that we may, at
                    ...
                    any comments; or (3) to respond to any comments.<br />We may, but
                    ...
                    property or these Terms of Service.<br />You agree that your
                  ...
                  <p>
                    ...
                    order).<br />We undertake no obligation to update, amend or
                  ...
                  <h3 class='font-medium'>SECTION 12 &ndash; PROHIBITED USES</h3>
                  <p>
                  ...
                  <h3 class='font-medium'>
                    SECTION 13 &ndash; DISCLAIMER OF WARRANTIES; LIMITATION OF
                    LIABILITY
                  </h3>
                  <p>
                    ...
                    of the service will be accurate or reliable.<br />You agree that
                    from time to time we may remove the service for indefinite periods
                    of time or cancel the service at any time, without notice to
                    you.<br />You expressly agree that your use of, or inability to
                    use, the service is at your sole risk. The service and all
                    products and services delivered to you through the
                    service&nbsp;are&nbsp;(except as expressly&nbsp;stated by&nbsp;us)
                    provided &lsquo;as is&rsquo; and &lsquo;as available&rsquo; for
                    ...
                    non-infringement.<br />In no case shall&nbsp;{{ $store.state.store.logoText }} Store,
                  ...
                  <h3 class='font-medium'>SECTION 14 &ndash; INDEMNIFICATION</h3>
                  <p>
                    You agree to indemnify, defend and hold harmless&nbsp;{{
                      $store.state.store.logoText
                    }}&nbsp;Store&nbsp;and&nbsp;our parent, subsidiaries, affiliates,
                    ...
                    incorporate by&nbsp;reference,&nbsp;or your violation of any law
                    or the rights of a third-party.
                  </p>
                  <h3 class='font-medium'>SECTION 15 &ndash; SEVERABILITY</h3>
                  <p>
                  ...
                  <h3 class='font-medium'>SECTION 16 &ndash; TERMINATION</h3>
                  <p>
                    ...
                    agreement for all purposes.<br />These Terms of Service are
                    ...
                    our site.<br />If in&nbsp;our sole&nbsp;judgment you&nbsp;fail, or
                  ...
                  <h3 class='font-medium'>SECTION 17 &ndash; ENTIRE AGREEMENT</h3>
                  <p>
                    The failure of us to exercise or enforce any right or provision of
                    these Terms of Service shall not constitute a waiver of such right
                    or provision.<br />These Terms of Service and any policies or
                    operating rules posted by us on this site or&nbsp;in&nbsp;respect
                    ...
                    Service).<br />Any ambiguities in the interpretation of these
                    Terms of Service shall not be construed against the drafting
                    party.
                  </p>
                  <h3 class='font-medium'>SECTION 18 &ndash; GOVERNING LAW</h3>
                  <p>
                    These Terms of Service and any separate agreements whereby we
                    provide you Services shall be governed by and construed in
                    accordance with the laws of UK.
                  </p>
                  <h3 class='font-medium'>SECTION 19 &ndash; CHANGES TO TERMS OF SERVICE</h3>
                  <p>
                ...
                <div v-else class='m-terms-content'>
